...
from .views import index, contato, buscar, criacao, atualizacao, deletar, registro, login_view, logout_view, atualizar_usuario
...
urlpatterns = [
    ...
    path('usuario/atualizacao_usuario/', atualizar_usuario, name='atualizar_usuario'),
